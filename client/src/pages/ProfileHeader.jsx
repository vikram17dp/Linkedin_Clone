...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
    ...
    const { mutate: rejectRequest } = useMutation({
		mutationFn: (requestId) => axiosInstance.put(`/connection/reject/${requestId}`),
		onSuccess: () => {
    ...
    const { mutate: removeConnection } = useMutation({
		mutationFn: (userId) => axiosInstance.delete(`/connection/${userId}`),
		onSuccess: () => {
			...
			<div className='p-4'>
				<div className='relative -mt-20 mb-4'>
					<img
						...
						src={editedData.profilepicture || userData.profilepicture || "/profile.png"}
						alt={userData.name}
					/>
